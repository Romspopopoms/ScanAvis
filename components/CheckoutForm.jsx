...
const stripePromise = loadStripe(process.env.REACT_APP_STRIPE_PUBLIC_KEY || 'ppk_test_51OPtGvDWmnYPaxs1gSpLL1WpDyU6gaxOBszqNCSu9iHVeEYuPcjUEvOpKzjwdbF6NUWquoEPf24Y3qMwIDLmeLvl00FwQkUSKx');
