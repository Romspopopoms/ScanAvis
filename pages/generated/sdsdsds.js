...
const Page = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const payload = {
      email,
      pageId: 'f9f65ba4-58c6-486c-8a8c-3eb81acf8baf',
      name: 'Romain Santiago',
      entreprise: 'Moiiiz',
      google_business: 'Jourezalsdjsfkez',
  ...
  return (
    ...
    >
      <div className="flex flex-col items-center">
        <img
          src="https://github.com/Romspopopoms/ScanAvis/blob/main/uploaded_images/check.png?raw=true"
          alt="Logo"
          className="mb-6 h-12 w-12"
        />
        <h1 className="text-4xl text-white mb-4">sdsdsds</h1>
        <form
