...
const Page = () => (
  ...
  >
    <div className="flex flex-col items-center">
      ...
      />
      <h1 className="text-5xl text-white mb-8">Jeabbot</h1>
      ...
      <button
        type="button"
        className="bg-transparent border border-white text-white py-2 px-6 rounded-full hover:bg-white hover:text-black transition-all duration-300 ease-in-out shadow-lg"
      >
        Envoyer
      </button>
    </div>
